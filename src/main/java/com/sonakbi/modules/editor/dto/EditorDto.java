...
import com.sonakbi.modules.editorTag.dto.EditorTagDto;
...
public class EditorDto {
    ...
    // private Set<EditorTagDto> editorTags = new HashSet<>();
    ...
    public EditorDto(Long id, String title, String mainText, String description, Account writer,
                     String url, String thumbnail, Set<EditorTag> editorTags, List<String> tags, boolean disclosure, LocalDateTime publishedTime,
        ...
        // this.editorTags = EditorTagDto.from(editorTags);
        // this.tags = tags;
    ...
    public EditorDto(Editor editor) {
        ...
        // this.editorTags = EditorTagDto.from(editor.getEditorTags());
        // this.tags = editor.getEditorTags().stream().map(tag -> tag.getTag().getValue()).collect(Collectors.toList());
        ...
        // this.comments = CommentDto.from(editor.getComments());
